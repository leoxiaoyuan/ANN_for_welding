...
obd_folder_root = "H:/PhD_data/CSF_results/round_2"
...
for odb_root in odb_root_list:
    ...
    with open('simulation_data.csv', 'a+') as f: # 采用b的方式处理可以省去很多问题
        writer = csv.writer(f)
        info = odb_root[56:-4]
        results = [info] + [bead_width] + [bead_depth] + target_stress_data
